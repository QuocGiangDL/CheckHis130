...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand btn btn-secondary" href="/index.php" data-toggle="tooltip" data-placement="top" title="ABERTOOL for MHL"><img class='pb-1' src="/style/logo2.png" height="30" alt="CoolBrand"> @MHL</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="check-mhl.php?id=1" data-toggle="tooltip" data-placement="right" title="ZIP GỐC là ZIP bạn vừa mới UPLOAD xong, không sửa đổi. Nếu muốn kiểm tra tính đúng đắn của 1 zip, đơn giản là UPLOAD lên">[MHL] 1. Kiểm tra Zip Gốc</a>
          <a class="dropdown-item" href="check-mhl.php?id=2" data-toggle="tooltip" data-placement="right" title="KIỂM TRA ZIP CONVERT sẽ không bị nút XOÁ DỮ LIỆU ảnh hưởng, mà sẽ bị xoá rồi ghi đè nếu convert zip vừa upload">[MHL] 2. Kiểm tra Zip Convert Gần đây nhất</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-light" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <a class="dropdown-item" href="convert.php">[MHL] 1. Convert [24.2.2023]</a>
        </div>
      </li>
       <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-light" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		...
		<a class="dropdown-item" href="xuatdl-so-cls.php">2.2. GỐC Xuất dữ liệu - CẬN LÂM SÀNG</a>
