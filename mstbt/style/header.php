...
if (strpos($url, 'check-mstbt.php?id=2') !== false)
{    $title =  "MSTBT - KIỂM TRA CONVERT - ABERTO TOOL"; }
elseif (strpos($url, 'check-mstbt.php?id=1') !== false)
{    $title =  "MSTBT - KIỂM TRA ZIP GỐC - ABERTO TOOL"; }
elseif (strpos($url, 'check-mstbt.php?id=2') !== false)
{    $title =  "MSTBT - KIỂM TRA ZIP CONVERT - ABERTO TOOL"; }
...
<html lang="en">
  <head>
    ...
    <meta name="description" content="MSTBT tool">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand btn btn-secondary" href="/index.php" data-toggle="tooltip" data-placement="top" title="ABERTOOL for MSTBT"><img class='pb-1' src="/style/logo2.png" height="30" alt="CoolBrand"> @MSTBT</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="check-mstbt.php?id=1" data-toggle="tooltip" data-placement="right" title="ZIP GỐC là ZIP bạn vừa mới UPLOAD xong, không sửa đổi. Nếu muốn kiểm tra tính đúng đắn của 1 zip, đơn giản là UPLOAD lên">[MSTBT] 1. Kiểm tra Zip Gốc</a>
          <a class="dropdown-item" href="check-mstbt.php?id=2" data-toggle="tooltip" data-placement="right" title="KIỂM TRA ZIP CONVERT sẽ không bị nút XOÁ DỮ LIỆU ảnh hưởng, mà sẽ bị xoá rồi ghi đè nếu convert zip vừa upload">[MSTBT] 2. Kiểm tra Zip Convert Gần đây nhất</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-light" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
        <a class="dropdown-item" href="convert.php">[MSTBT] 1. Convert [24.2.2023]</a>
        </div>
      </li>
       <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-light" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
