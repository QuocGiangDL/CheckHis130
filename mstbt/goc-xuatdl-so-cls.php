...
$random_name = rand(1000000, 10000000) . "-QQ-so-cls.csv";
 ...
 $chitiets = tag_contents($content3, "<CHI_TIET_DVKT>", "</CHI_TIET_DVKT>");
    foreach ($chitiets as $chitiet)
    {
        ...
        if (strpos($TEN_DICH_VU, 'Khám mắt') !== false)
        {
            ...
            $BS_CHI_DINH = str_replace("010440/NA-CCHN", "KTV Hằng", $BS_CHI_DINH);
        ...
        $NGUOI_THUC_HIEN = str_replace("010440/NA-CCHN", "KTV Hằng", $NGUOI_THUC_HIEN);
